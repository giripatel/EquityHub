      ...
      <div className="flex h-14 w-full flex-col justify-center pl-[21px] pr-4 ">
        <div className="flex flex-row justify-between">
          <div className="flex items-center flex-row">
            <a
              className="text-center font-semibold rounded-lg focus:ring-blue-200 focus:none focus:outline-none hover:opacity-90 disabled:opacity-80 disabled:hover:opacity-80 flex flex-col justify-center bg-transparent h-8 text-sm p-0 mr-6 shrink-0"
              href="/"
            >
            ...
            <div className="ml-[20px] mr-[20px] flex flex-row items-center justify-center">
              <a
                className="text-center text-gray-100 font-semibold rounded-lg focus:ring-blue-200 focus:none focus:outline-none hover:opacity-90 disabled:opacity-80 disabled:hover:opacity-80 flex flex-col justify-center bg-transparent h-8 text-sm p-0 text-baseTextMedEmphasis"
                href="/"
              >
                Markets
              </a>
          ...
          <div className="flex flex-row">
            ...
            <a
              className="my-auto ml-6 text-nowrap rounded-lg bg-[#4c94ff29] text-blue-500 px-3 py-1.5 text-sm font-semibold text-accentBlue hover:opacity-90"
              href="/login"
            >
              Sign in
            </a>
